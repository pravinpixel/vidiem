<div style="border:1px solid black;margin:30px;padding:30px;font-family:arial;" >
    ...
    <span > Dear Customer, <br>Thank you for your order at Vidiem Online Store. Please find the attached proforma invoice for your order reference. Once your package ships we will send an email with a link to track your order. <br><br>If you have questions about your order, you can email us at care@vidiem.in. </span>
     <h3 style="color:#fff;padding:10px 5px;font-size:14px; background:#F7000A;">Order Date:&nbsp; '.date("d-M-Y", strtotime(@$order_data['created'])).' 
                 | Order No. :&nbsp;'.@$order_data['inv_code'].' </h3>  <hr> Thank you for shopping with us!<br>Team Vidiem  <br><br>  <span style="font-size:12px; text-transform:uppercase;">Maya Appliances Pvt Ltd,<br>No. 3/140, Old Mahabalipuram Road,<br> Oggiam Thoraipakkam, <br>Chennai - 600097, Tamilnadu, INDIA. 
               <br> Phone : &nbsp; 044-6635 6635 / 77110 06635  | Website  : &nbsp;  <a href="https://www.vidiem.in">vidiem.in</a>             | GST NO  : &nbsp; 33AAACM6280D1ZT </span></div>
