		...
		<div id="main">
			...
			<input type="hidden" id="langset" name="langset" value="en_US" />
				<fieldset>
                    ...
                    <input type='text' name='mega_google_api' id='mega_google_api' value='<?php echo MEGA_GOOGLE_API; ?>' />
					<small>(Required <a href="http://superstorefinder.net/support/knowledgebase/google-maps-api-keys-usage-and-limits/" target="new">more details</a>)</small>						
					</div>
					
					<div class='input'>
                    <label>Google Geocoding key</label>
                    <input type='text' name='mega_geocode_google_api' id='mega_geocode_google_api' value='<?php echo MEGA_GEOCODE_GOOGLE_API; ?>' />
					<small>(Required <a href="http://superstorefinder.net/support/knowledgebase/create-google-geocoding-key/" target="new">more details</a>)</small>						
					</div>
