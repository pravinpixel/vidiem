	...
	<div id="wrapper">
		...
		<div class="links"></div>
			...
			<form method="post" action="./index.php" accept-charset="UTF-8" method="post" id="clinic-finder-form" class="clear-block" class="clear-block">
				...
				// support unicode
				mysql_query("SET NAMES utf8");
				$cats = $db->get_rows("SELECT categories.* FROM categories WHERE categories.id='1' ORDER BY categories.cat_name ASC");
				...
				<input type="hidden" id="distance" name="distance" value="200">
					  ...
					  <div id="results">        
						<h2>Customer Care Centers<?php //echo $lang['STORES_NEAR_YOUR']; ?></h2>
