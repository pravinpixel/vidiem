                ...
                <div class="form-group">
                  ...
                  <select class="selectpicker js-states form-control complaint_category custome-select" data-live-search="true" name="category" id="category">
                      ...
                      <?php if(!empty($category)){ 
                          ...
                          <option value="<?= $info['id']; ?>" <?= set_select('category',$info['name'],($info['id'] == $productComplaint->category?TRUE:''));?>><?= $info['name']; ?></option>
                        <?php } } ?>  
                    </select>
                    <?= form_error('category'); ?>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <select name="product_name" id="inputProduct" class="form-control complaint_pro_list custome-select">
                      ...
                      <?php if(!empty($products)){ 
                          ...
                          <option value="<?= $product['id']; ?>" <?= set_select('product_name',$product['name'],($product['id']==$productComplaint->product?TRUE:''));?>><?= $product['name']; ?></option>
                        <?php } } ?>  
                    </select>
