...
<?php } ?> 
	 ...
	 <script type="text/javascript" src="<?= base_url(); ?>assets/front-end/js/stickySidebar.js"></script>
      ...
      <script src="<?= base_url(); ?>assets/front-end/js/main-customize.js"></script>
