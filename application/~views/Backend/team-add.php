      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="post" action="<?= base_url('Admin/team/add'); ?>" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-10">
                    <input type="text" class="form-control" id="inputPosition" name="position" value="<?= set_value('position'); ?>">
                    <?= form_error('position'); ?>
                  </div>
                </div>
				 <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-10">
                    <input type="text" class="form-control" id="inputExperience" name="exp" value="<?= set_value('exp'); ?>">
                    <?= form_error('exp'); ?>
                  </div>
                </div>
                <div class="form-group">
