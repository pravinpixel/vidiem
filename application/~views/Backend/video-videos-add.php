      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="post" action="<?= base_url('Admin/video/add_video/'.$id); ?>" enctype="multipart/form-data">
              <div class="box-body">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-6">
                      <input type="text" class="form-control" id="urllink" name="urllink" value="<?= set_value('urllink'); ?>">
                    <?= form_error('urllink'); ?>
                    </div>
                </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-10">
                    <textarea id="description" cols="30" rows="3" class="form-control" name="description"><?= set_value('description'); ?></textarea>
                  </div>
                </div>
