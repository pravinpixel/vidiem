  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Type of Lid</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"> Type of Lid View</h3>
               <div class="pull-right">
                 <a href="<?php echo base_url('Admin/typeoflid/create');?>" class="btn btn-success">Add Type of Lid <span class=""></span></a> 
              </div>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="box-body table-responsive">
              <table id="typeoflid" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th></th>
                  <th>S.No</th>
...
<?php
$ajaxurl="typeoflid/display_datatble_list";
$frmname="typeoflid";
$columns_arr=array("typeoflidname");
