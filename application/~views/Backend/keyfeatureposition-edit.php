        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Key Feature Position</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="post" action="<?= base_url('Admin/Keyfeatureposition/edit'); ?>" enctype="multipart/form-data">
              <div class="box-body">
               <input type="hidden" name="hidden_id" value="<?php echo set_value('hidden_id',$edit_id); ?>" />
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-10">
                    <input type="text" class="form-control" id="position" name="position" value="<?= set_value('position',$Edit_Result['position']); ?>">
                    <?= form_error('position'); ?>
                  </div>
                </div>	
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-10">
                    <select name="columnname" id="columnname" class="form-control">
					  ...
					  <option value="col-1" <?= set_select('columnname','col-1',('col-1'==$Edit_Result['columnname']?TRUE:''));?>>col-1</option>
					  <option value="col-2">col-2</option>
					  <option value="col-3">col-3</option>
					  <option value="col-4" <?= set_select('columnname','col-1',('col-1'==$Edit_Result['columnname']?TRUE:''));?>>col-4</option>
