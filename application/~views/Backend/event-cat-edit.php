  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?= base_url('Admin/event/eventcat/'.$id); ?>">Event</a></li>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
             <form class="form-horizontal" method="post" action="<?= base_url('Admin/event/eventcatedit'); ?>" enctype="multipart/form-data">
             <div class="box-body">
               ...
               <div class="form-group">
                  <label for="inputQuestion" class="col-sm-2 control-label">Link</label>
                  <div class="col-md-6 col-sm-10">
                    <input type="text" class="form-control" id="inputLink" name="link" value="<?= set_value('link',$Edit_Result['link']); ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-10">
                    <textarea class="form-control ckeditor" id="inputContent" name="content"><?= set_value('content',$Edit_Result['content']); ?></textarea>
                    <?= form_error('content'); ?>
                  </div>
                </div>
