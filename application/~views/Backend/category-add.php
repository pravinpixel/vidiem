      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="post" action="<?= base_url('Admin/category/add'); ?>" enctype="multipart/form-data">
              <div class="box-body">
				...
				<div class="form-group">
                  <label for="imageicon" class="col-sm-2 control-label">Image Icon <span class="red">*</span></label>
                  <div class="col-sm-6">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-md-9 col-sm-10">
                    <textarea id="content" cols="30" rows="3" class="form-control ckeditor" name="content"><?= set_value('content'); ?></textarea>
                     <?= form_error('content'); ?>
                  </div>
                </div>
