      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="post" action="<?= base_url('Admin/press/edit'); ?>" enctype="multipart/form-data">
              <div class="box-body">
               <input type="hidden" name="hidden_id" value="<?php echo set_value('hidden_id',$edit_id); ?>" />
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-10">
                    <input type="text" class="form-control" id="inputplace" name="place" value="<?= set_value('place',$Edit_Result['place']); ?>">
                    <?= form_error('place'); ?>
                  </div>
                </div>
				<div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-10">
                    <input type="date" class="form-control" id="inputpressdate" name="pressdate" value="<?= set_value('pressdate',$Edit_Result['pressdate']); ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="col-sm-4">
                      <img src="<?= base_url('uploads/press/'.$Edit_Result['image']); ?>" width="100px" height="100px" class="UploadImgPreview img-responsive">
                    </div>
                </div>
                  <div class="form-group">
				...
				<div class="form-group">
                  ...
                  <div class="col-md-9 col-sm-10">
                    <textarea id="inputShortDescription" cols="30" rows="3" class="form-control ckeditor" name="description"><?= set_value('description',$Edit_Result['description']); ?></textarea>
