  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Customize Base</li>
      </ol>
    </section>
            ...
            <div class="box-header with-border">
              <h3 class="box-title"> Customize Base View</h3>
               <div class="pull-right">
                 <a href="<?php echo base_url('Admin/customizebase/create');?>" class="btn btn-success">Add Base <span class=""></span></a> 
              </div>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="box-body table-responsive">
              <table id="customizebase" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th></th>
                  <th>S.No</th>
...
<?php
$ajaxurl="customizebase/display_datatble_list";
$frmname="customizebase";
$columns_arr=array("basepath","basetitle","price","option");
