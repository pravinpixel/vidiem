        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">View Cancel Request</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?= @date('d-M-Y',strtotime($info['cancel_request_data'])); ?></td>
                  <td><?= $info['created']; ?></td>
                  <td>
                      ...
                      <a href="javascript:void(0);" class="btn btn-danger order_cacel_trigger" data-toggle="tooltip" data-placement="top" data-original-title="Cancel" data-url="<?= base_url('Admin/customizeorders/orderCancel/'.$info['id']);?>">
