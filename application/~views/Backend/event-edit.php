      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="post" action="<?= base_url('Admin/event/edit'); ?>" enctype="multipart/form-data">
              <div class="box-body">
               <input type="hidden" name="hidden_id" value="<?php echo set_value('hidden_id',$edit_id); ?>" />
                 <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-10">
                    <select name="page" id="inputPage" class="form-control">
                     ...
                     <option value="1">Awards and Recognition</option>
				...
				<div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-10">
			<input type="date" class="form-control" id="inputpressdate" name="eventdate" value="<?= set_value('eventdate',$Edit_Result['eventdate']); ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="col-sm-4">
                      <img src="<?= base_url('uploads/event/'.$Edit_Result['image']); ?>" width="100px" height="100px" class="UploadImgPreview img-responsive">
                    </div>
                </div>
