...
<?php $this->load->view('Backend/container/sidebar'); ?>
  ...
  <?php
     ...
     if($action=="Create")
	 {
		$actionurl=	base_url('Admin/typeofhandle/save/'); 
		$actionbtn="Submit";
	 }
	 else
	 {
		$actionurl=	base_url('Admin/typeofhandle/update/'.$dataitems->typeofhandle_id); 
		$actionbtn="Update";
	 }	 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?= base_url('Admin/typeofhandle'); ?>">Type of Handle</a></li>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"><?php echo $action; ?> Type of Handle</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" id="frmcolor" name="frmcolor" method="post" action="<?php echo $actionurl; ?>">
              <div class="box-body">
               ...
               <div class="form-group">
                  <label for="inputName" class="col-sm-2 control-label">Type of Handle<span class="red">*</span></label>
                  <div class="col-md-6 col-sm-10">
                    <input type="text" class="form-control" id="inputName" name="typeofhandlename" value="<?= set_value('typeofhandlename',@$dataitems->typeofhandlename); ?>">
                    <?= form_error('typeofhandlename'); ?>
                  </div>
                </div>
			<!-- <div class="form-group">
                  <label for="inputName" class="col-sm-2 control-label">Color Code  <span class="red">*</span></label>
                  <div class="col-md-6 col-sm-10">
                    <input type="text" class="form-control" id="inputName" name="colorcode" value="<?= set_value('colorcode',@$dataitems->colorcode); ?>">
                    <?= form_error('colorcode'); ?>
                  </div>
              </div> -->
