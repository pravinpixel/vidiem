  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?= base_url('Admin/faq/faqcat/'.$id); ?>">FAQs</a></li>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Edit FAQ - <?= $title; ?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
             <form class="form-horizontal" method="post" action="<?= base_url('Admin/faq/faqedit'); ?>" enctype="multipart/form-data">
             <div class="box-body">
               <input type="hidden" name="hidden_id" value="<?php echo set_value('hidden_id',$edit_id); ?>" />
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-10">
                    <input type="text" class="form-control" id="inputQuestion" name="question" value="<?= set_value('question',$Edit_Result['question']); ?>">
                    <?= form_error('question'); ?>
                  </div>
                </div>
