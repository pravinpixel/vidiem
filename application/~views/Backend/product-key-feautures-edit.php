  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?= base_url('Admin/products/key_feautres/'.$id); ?>">Key Features</a></li>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Key Features - <?= $name; ?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="post" action="<?= base_url('Admin/products/key_feautres_edit'); ?>" enctype="multipart/form-data">
              <div class="box-body">
               <input type="hidden" name="hidden_id" value="<?php echo set_value('hidden_id',$edit_id); ?>" />
				...
				<textarea class="ckeditor form-control" id="content" name="content" ><?= set_value('content',@$Edit_Result['content']); ?></textarea>
				 <small>HighLight text (Ex) : &lt;div class="text-red"&gt;5 Year&lt;/div&gt;</small>
                  </div>
