        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"> Capacity View</h3>
               <div class="pull-right">
                 <a href="<?php echo base_url('Admin/capacity/create');?>" class="btn btn-success">Add Capacity <span class=""></span></a> 
              </div>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="box-body table-responsive">
              <table id="capacity" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th></th>
                  <th>S.No</th>
...
<?php
$ajaxurl="capacity/display_datatble_list";
$frmname="capacity";
$columns_arr=array("capacityname");
