...
<?php $this->load->view('Backend/container/sidebar'); ?>
  ...
  <?php
     ...
     if($action=="Create")
	 {
		$actionurl=	base_url('Admin/typeofjar/save/'); 
		$actionbtn="Submit";
	 }
	 else
	 {
		$actionurl=	base_url('Admin/typeofjar/update/'.$dataitems->typeofjar_id); 
		$actionbtn="Update";
	 }	 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?= base_url('Admin/typeofjar'); ?>">Type of Jar</a></li>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"><?php echo $action; ?> Type of Jar</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" id="frmcolor" name="frmcolor" method="post" action="<?php echo $actionurl; ?>">
              <div class="box-body">
               ...
               <div class="form-group">
                  <label for="inputName" class="col-sm-2 control-label">Type of Jar<span class="red">*</span></label>
                  <div class="col-md-6 col-sm-10">
                    <input type="text" class="form-control" id="inputName" name="typeofjarname" value="<?= set_value('typeofjarname',@$dataitems->typeofjarname); ?>">
                    <?= form_error('typeofjarname'); ?>
                  </div>
                </div>
			<!-- <div class="form-group">
