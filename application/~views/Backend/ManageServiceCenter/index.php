        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Manage Service Center View</h3>
               <div class="pull-right">
                 <a href="<?php echo base_url('Admin/ManageServiceCenter/create');?>" class="btn btn-success">Add Service Center <span class=""></span></a> 
              </div>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="box-body table-responsive">
              <table id="manageservicecenter" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th></th>
                  <th>S.No</th>
...
<?php
$ajaxurl="ManageServiceCenter/display_datatble_list";
$frmname="manageservicecenter";
