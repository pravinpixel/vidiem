      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="post" action="<?= base_url('Admin/notification/edit'); ?>" enctype="multipart/form-data">
              <div class="box-body">
               <input type="hidden" name="hidden_id" value="<?php echo set_value('hidden_id',$edit_id); ?>" />
                <div class="form-group">
                 ...
                 <div class="form-group">
                  <label for="inputQuestion" class="col-sm-2 control-label">URL</label>
                  <div class="col-md-6 col-sm-10">
                    <input type="text" class="form-control" id="inputtitle" name="url" value="<?= set_value('url',$Edit_Result['url']); ?>">
                    <?= form_error('url'); ?>
                  </div>
                </div>
                <div class="form-group">
