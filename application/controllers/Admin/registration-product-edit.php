                ...
                <div class="form-group">
                  ...
                  <select class="selectpicker js-states form-control custome-select complaint_category" data-live-search="true" name="category_" id="category_">
                      ...
                      <?php if(!empty($category)){ 
                          ...
                          <option  value="<?= $info['id'].'#'. $info['name']; ?>" <?= set_select('category',$info['name'],($info['name'] == $productRegistration->category ?TRUE:''));?>><?= $info['name']; ?></option>
                        <?php } } ?>  
                    </select>
                    <?= form_error('category'); ?>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <select name="product_name" id="inputProduct" class="form-control custome-select complaint_pro_list">
                      ...
                      <?php if(!empty($products)){ 
                          ...
                          <option value="<?= $product['name']; ?>" <?= set_select('product_name',$product['name'],( $product['name'] == $productRegistration->Product ? TRUE:''));?>><?= $product['name']; ?></option>
                        <?php } } ?>  
                    </select>
