					...
					<td style="width:85%">
						...
						if(count($jarinfo)>0) {	
						  $return['modal_content'].='	<table border="0" cellpadding="7" cellspacing="0" style="width:600px;border:1px solid #CCC; margin-bottom: 20px;">
							...
							<table border="0" cellpadding="7" cellspacing="10" style="width:600px;border:1px solid #CCC; margin-bottom: 20px;padding:10px;">
							<td style="border-bottom:1px solid #CCC;color:#ff0000;"> <strong>Warranty Information</strong></td></tr>
							<tr><td> - 2 Years Warranty on Product <br> - 5 Years Warranty on Motor</td></tr></table>
					</td>
				</tr>
            </table> ';
...
Oggiam Thoraipakkam,<br>Chennai - 600097, Tamilnadu, INDIA.</li>
        ...
        <div class="form" style="width:100%;"> ';
				 $data['content'].=' <table style="width:100%; padding:20px 0 40px 0;">
                <tr>
					<td style="width:15%">
						<img src="'.base_url('uploads/customizeimg/'.$basiciteminfo['basecolorpath']).'" style="margin: 0; border: 0; padding: 0; display: block;" width="160" height="160">
					</td>
					<td style="width:85%">
						...
						if(count($jarinfo)>0) {	
						  $data['content'].='	<table border="0" cellpadding="7" cellspacing="0" style="width:600px;border:1px solid #CCC; margin-bottom: 20px;">
								<thead>
									<tr>
										<th style="border-bottom:1px solid #CCC;"></th>
										<th style="border-bottom:1px solid #CCC;"></th>
