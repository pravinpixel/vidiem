...
.container{width:100%;}
   ...
   <div class="container inCon">
        ...
        <div style="width:30%;float:right;"><h1 style="color:#00BFFF;">Proforma Invoice a</h1></div>
        ...
        <div class="form" style="width:100%;"> ';
            $return['modal_content'].=' <table style="width:100%; padding:20px 0 40px 0;">
                ...
                $return['modal_content'].='<table style="width:100%; padding:20px 0 40px 0;">
                    ...
                    <td></td>
                    <th style="text-align:right;" colspan="3">Package Amount</th>
                    <th style="padding:10px 0;text-align:right;"><b>'.number_format($order_data['packageprice'],2,'.','').'</b></th>
                </tr>';
                if($order_data['coupon_id']!=0){
                 ...
                 $return['modal_content'].='<tr>
                  ...
                  <tr><td colspan="4" style="text-align:center; font-size:12px;">care@vidiem.in and If you have any queries in the orders, Please write us to orders@vidiem.in </td></tr>
