        ...
        $return['modal_content']='
                ...
                Oggiam Thoraipakkam, Chennai - 600097, Tamilnadu, INDIA.</li>
                    ...
                    <tr ><td colspan="2"><h3 style="color:#fff;padding:10px 5px;font-size:14px; background:#3B4E87;">Items Orderd</h3> </td> </tr>
                                <tr>
                                    ...
                                    <td style="width:85%">
                                        ...
                                        <tr>	<td style="border-bottom:1px solid #CCC;color:#ff0000;"> <strong>Warranty Information</strong></td></tr>
                                            <tr><td> - 2 Years Warranty on Product <br> - 5 Years Warranty on Motor <br> <span style="color:#ff0000;font-size:10px;"><i>(For Domestic Purpose Only)</i></span></td></tr></table>
                                    </td>
                                </tr>
                            </table> ';
                        ...
                        $return['modal_content'].='<tr><td></td><td></td>
                        <td style="font-size:12px;">Note: This is computer generated invoice hence no signature required.</td>
                        <td style="font-size:12px;">If you have any questions about this invoice, please write us to care@vidiem.in </td>
        ...
        <div class="detail" style="float:left;width:49%;">
            ...
            <ul style="width:100%; display:inline-block; margin:0; padding:0;list-style:none;font-family:Arial;">
                ...
                if(!empty($order_data['billing_company_name'])){
                  ...
                  $data['content'].='</li>
                <li style="font-size:11px;"><span style="width:22%;list-style:none;line-height:28px; display:inline-block;">Address</span> : &nbsp;<span>'.@$order_data['billing_address'].', '.@$order_data['billing_address2'].'
                </span></li>
         ...
         <div class="detail" style="float:left;width:50%;">
             ...
             <ul style="width:100%; display:inline-block; margin:0; padding:0;list-style:none;font-family:Arial;">
                ...
                if(!empty($order_data['delivery_company_name'])){
                  ...
                  $data['content'].='</li>
                <li style="font-size:11px;"><span style="width:22%;list-style:none;line-height:28px; display:inline-block;">Address</span> : &nbsp;'.@$order_data['delivery_address'].', '.@$order_data['delivery_address2'].'
                </li>
        ...
        <div class="form" style="width:100%;"> ';
                ...
                if($order_data['coupon_id']!=0){
                  ...
                  <tr>
                   ...
                   $data['content'].='<tr><td></td><td style="font-size:10px;">Note: This is computer generated invoice hence no signature required. | If you have any questions about this invoice, please write us to care@vidiem.in </td></tr>
