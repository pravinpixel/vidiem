...
class LocationsModel extends CI_Model {
    ...
    function getInfoByRandomColumn( $table, $id ) {
        return $this->db->select('location.*,sale.open_password, sale.id as sale_user_id,sale.user_id as s_user_name, sale.user_code as s_user_code,sale.password as s_password,counter.id as counter_user_id,counter.user_id as c_user_name, counter.user_code as c_user_code,counter.password as c_password,')
