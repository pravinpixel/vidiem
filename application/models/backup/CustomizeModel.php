...
class CustomizeModel extends CI_Model {
  ...
  public function getDataArrById($id,$table_name,$field_name)
    ...
    public function Custom_NewOrderNotification($order_id){
        ...
        $order_info=$this->FunctionModel->Select_Fields_Row('client_id,inv_code,amount,billing_emailid,billing_mobile_no','vidiem_customorder',array('id'=>$order_id));
        ...
        $this->ProjectModel->SMS($clt_info['mobile_no'],$sms_content);
         ...
         $sms_content='New Order On Vidiem Invoice Code '.$order_info['inv_code'].'. Invoice Amount'.$order_info['amount'];
           $this->ProjectModel->SMS(AdminMobile,$sms_content);
			...
			$subject='Vidiem Order Confirmation';
            $msg='<p>Dear Customer,<br> Thank you for your order. We’ll send a confirmation when your order processed further.  If you would like to know the status of your order please visit Vidiem.in <br>Order Code '.$order_info['inv_code'];
			$this->FunctionModel->sendmail1($clt_info['email'],$msg,$subject,InfoMail);

	//	$subject='New Order on Vidiem Site';
			$subject='New order – Vidiem by You – '.$order_info['inv_code'];
				$msg='<p>Dear Team,<br>  <br>&nbsp;&nbsp; New Order on Vidiem By You. <br>Invoice Code'.$order_info['inv_code'].'. Invoice Amount'.$order_info['amount'];
 ...
 $this->FunctionModel->sendmail('prodmgsrk@mayaappliances.com,palani.j@mayaappliances.com,venkatesan@mayaappliances.com,em@mayaappliances.com,syed.m@mayaappliances.com,ramakrishnan.n@mayaappliances.com,itsupport@mayaappliances.com,balakrishnan.s@mayaappliances.com,thulasiraman.s@mayaappliances.com,onlinesales@mayaappliances.com,mktg1@mayaappliances.com,qasrk@mayaappliances.com,anandan.c@mayaappliances.com,rnd@mayaappliances.com,murugan.k@mayaappliances.com,satheyaraaj.t@mayaappliances.com',$msg,$subject,InfoMail);
   ...
   /*   $this->FunctionModel->sendmail('prodmgsrk@mayaappliances.com',$msg,$subject,InfoMail);
      $this->FunctionModel->sendmail('palani.j@mayaappliances.com',$msg,$subject,InfoMail);
      $this->FunctionModel->sendmail('venkatesan@mayaappliances.com',$msg,$subject,InfoMail);
      $this->FunctionModel->sendmail('em@mayaappliances.com',$msg,$subject,InfoMail);
      $this->FunctionModel->sendmail('syed.m@mayaappliances.com',$msg,$subject,InfoMail);
      $this->FunctionModel->sendmail('ramakrishnan.n@mayaappliances.com',$msg,$subject,InfoMail);
      $this->FunctionModel->sendmail('itsupport@mayaappliances.com',$msg,$subject,InfoMail);
      $this->FunctionModel->sendmail('balakrishnan.s@mayaappliances.com',$msg,$subject,InfoMail);
      $this->FunctionModel->sendmail('thulasiraman.s@mayaappliances.com',$msg,$subject,InfoMail);
      $this->FunctionModel->sendmail('onlinesales@mayaappliances.com',$msg,$subject,InfoMail);
      $this->FunctionModel->sendmail('mktg1@mayaappliances.com',$msg,$subject,InfoMail);
      $this->FunctionModel->sendmail('qasrk@mayaappliances.com',$msg,$subject,InfoMail);
       $this->FunctionModel->sendmail('anandan.c@mayaappliances.com',$msg,$subject,InfoMail);
        $this->FunctionModel->sendmail('rnd@mayaappliances.com',$msg,$subject,InfoMail);
         $this->FunctionModel->sendmail('murugan.k@mayaappliances.com',$msg,$subject,InfoMail);
         $this->FunctionModel->sendmail('satheyaraaj.t@mayaappliances.com',$msg,$subject,InfoMail);
*/
    }
...
Oggiam Thoraipakkam,<br>Chennai - 600097, Tamilnadu, INDIA.</li>
   ...
   $this->m_pdf->pdf->AddPage('P', // L - landscape, P - portrait
      ...
      $this->FunctionModel->sendmail($client['email'],$template,'New Order - Vidiem By You','care@vidiem.in',$attachdata);
     $this->FunctionModel->sendmail('prodmgsrk@mayaappliances.com,palani.j@mayaappliances.com,venkatesan@mayaappliances.com,em@mayaappliances.com,syed.m@mayaappliances.com,ramakrishnan.n@mayaappliances.com,itsupport@mayaappliances.com,balakrishnan.s@mayaappliances.com,thulasiraman.s@mayaappliances.com,onlinesales@mayaappliances.com,mktg1@mayaappliances.com,qasrk@mayaappliances.com,anandan.c@mayaappliances.com,rnd@mayaappliances.com,murugan.k@mayaappliances.com,satheyaraaj.t@mayaappliances.com',$template,'New Order - Vidiem By You','care@vidiem.in',$attachdata);
      $this->FunctionModel->sendmail('saravanan.p@mayaappliances.com, john@pixel-studios.com',$template,'New Order - Vidiem By You','care@vidiem.in',$attachdata);
