...
class CustomizeModel extends CI_Model
{
    ...
    public function Custom_NewOrderNotification($order_id)
    {
        ...
        if (isset($order_info['payment_source']) && $order_info['payment_source'] == 'counter' && empty( $order_info['pg_type'] ) ) {
            $client_mail_subject                = 'Vidiem By You - Showing Interest ';
        ...
        $this->FunctionModel->send_office_mail( 'prodmgsrk@mayaappliances.com,palani.j@mayaappliances.com,venkatesan@mayaappliances.com,em@mayaappliances.com,syed.m@mayaappliances.com,ramakrishnan.n@mayaappliances.com,itsupport@mayaappliances.com,balakrishnan.s@mayaappliances.com,thulasiraman.s@mayaappliances.com,onlinesales@mayaappliances.com,mktg1@mayaappliances.com,qasrk@mayaappliances.com,anandan.c@mayaappliances.com,rnd@mayaappliances.com,murugan.k@mayaappliances.com,satheyaraaj.t@mayaappliances.com',$admin_mail_msg,$admin_mail_subject,InfoMail);
	    $this->FunctionModel->send_office_mail( 'saravanan.p@mayaappliances.com,john@pixel-studios.com',$admin_mail_msg,$admin_mail_subject,InfoMail);
...
<div class="detail" style="float:left; width:50%;">
        ...
        $this->FunctionModel->send_office_mail($client['email'],$template2,$client_mail_subject,'care@vidiem.in',$attachdata);
        $this->FunctionModel->send_office_mail('prodmgsrk@mayaappliances.com,palani.j@mayaappliances.com,venkatesan@mayaappliances.com,em@mayaappliances.com,syed.m@mayaappliances.com,ramakrishnan.n@mayaappliances.com,itsupport@mayaappliances.com,balakrishnan.s@mayaappliances.com,thulasiraman.s@mayaappliances.com,onlinesales@mayaappliances.com,mktg1@mayaappliances.com,qasrk@mayaappliances.com,anandan.c@mayaappliances.com,rnd@mayaappliances.com,murugan.k@mayaappliances.com,satheyaraaj.t@mayaappliances.com',$template,'New Order - Vidiem By You','care@vidiem.in',$attachdata);
        $this->FunctionModel->send_office_mail('saravanan.p@mayaappliances.com, john@pixel-studios.com',$template2,'New Order - Vidiem By You','care@vidiem.in',$attachdata);
        /*  
