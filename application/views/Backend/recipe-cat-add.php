        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Add Recipe - <?= $title; ?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
 <form class="form-horizontal" method="post" action="<?= base_url('Admin/recipe/recipecatadd/'.$id); ?>" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-10">
                    <textarea class="form-control ckeditor" id="inputcontent" name="content"><?= set_value('content'); ?></textarea>
                    <?= form_error('content'); ?>
                  </div>
                </div>
                   <h4 class="box-title">IncredeDetail- <?= $title; ?></h4>
               <div class="form-group">
                  <label for="inputAnswer" class="col-sm-2 control-label">Content</label>
                  <div class="col-md-6 col-sm-10">
                    <textarea class="form-control ckeditor" id="inputincrecontent" name="increcontent"><?= set_value('increcontent'); ?></textarea>
