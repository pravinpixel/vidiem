        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Manage City View</h3>
               <div class="pull-right">
                 <a href="<?php echo base_url('Admin/managecity/create');?>" class="btn btn-success">Add Service City <span class=""></span></a> 
              </div>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="box-body table-responsive">
              <table id="managecity" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th></th>
                  <th>S.No</th>
...
<?php
$ajaxurl="managecity/display_datatble_list";
$frmname="managecity";
$columns_arr=array("cityname","statename");
