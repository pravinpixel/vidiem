...
<?php include_once('container/sidebar.php'); ?>
  ...
  <div class="content-wrapper">
            ...
            <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?= $info['created']; ?></td>
                  <td>
                      <a href="#" class="btn bg-green uncompleted_order" data-toggle="modal" data-target="#uncompleted-order" data-id="<?= $info['id']; ?>" ><span class="fa fa-cogs"></span></a>
    ...
    <!-- /.content -->
    <!-- modal  -->
    <div class="modal fade" id="uncompleted-order">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" action="">
                      <div class="form-group">
                        ...
                        <input type="hidden" name="uncompleted_order_id" id="uncompleted_order_id">
                        <div class="col-sm-9">
                ...
                <div class="modal-footer">
                    <div class="pull-right"> 
                      ...
                      <button type="submit" class="btn btn-primary update_uncompleted_order_status">Submit</button>
                    </div>
                </div>
            </div>
        </div>
