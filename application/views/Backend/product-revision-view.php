            ...
            <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?= $info['created']; ?></td>
                  <td>
                      <a href="javascript:void(0);" class="btn bg-navy revision_product_view" data-id="<?= $info['id']; ?>" data-toggle="tooltip" data-placement="left"  data-original-title="view"><span class="fa fa-eye"></span></a>
                  </td>
                </tr>
                <?php  $x++; }
                }else { ?>
