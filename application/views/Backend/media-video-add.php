  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?= base_url('Admin/mediavideo/video/'.$id); ?>">Media Video</a></li>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Media Video - <?= $title; ?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="post" action="<?= base_url('Admin/mediavideo/add_video/'.$id); ?>" enctype="multipart/form-data">
              <div class="box-body">
               <div class="form-group">
                  <label for="inputVideo" class="col-sm-2 control-label">Name</label>
                  <div class="col-sm-6">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                      <input type="text" class="form-control" id="inputVideoURL" name="videourl" value="<?= set_value('videourl'); ?>">
                    <?= form_error('videourl'); ?>
                    </div>
                </div>
