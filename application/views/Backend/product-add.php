      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="post" action="<?= base_url('Admin/products/add'); ?>" enctype="multipart/form-data">
              <div class="box-body">
                    ...
                    <select name="sub_category" id="inputSubCategory" class="form-control sub_category">
                      <option value="">Select Sub Category</option>
                       <?php if(!empty($sub_category)){ 
                          ...
                          <option value="<?= $info['id']; ?>" <?= set_select('sub_category',$info['id']);?>><?= $info['name']; ?></option>
                        <?php } } ?>  
                    </select>
                ...
                <!--<div class="form-group">
                  <label for="productkeyfeature" class="col-sm-2 control-label">Product Key Feature</label>
                  <div class="col-md-6 col-sm-10">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-10">
                    <input type="text" class="form-control" id="inputModal" name="modal_no" value="<?= set_value('modal_no'); ?>">
                    <?= form_error('modal_no'); ?>
                  </div>
                </div>
                  ...
                  <div class="col-md-6 col-sm-10">
                    <div class="checkbox icheck">
                      <label for="inputexclusive">
                        <input type="checkbox" value="1" name="exclusive" id="inputexclusive" <?= set_checkbox('exclusive','1'); ?>> Yes
                      </label>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label for="inputfeatured" class="col-sm-2 control-label">Featured Product</label>
                  <div class="col-md-6 col-sm-10">
                    <div class="checkbox icheck">
                      <label for="inputfeatured">
                        <input type="checkbox" value="1" name="featured" id="inputfeatured" <?= set_checkbox('featured','1'); ?>> Yes
                      </label>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-10">
                    <div class="checkbox icheck">
                      <label for="inputnew">
                        <input type="checkbox" value="1" name="new_launches" id="inputnew" <?= set_checkbox('new_launches','1'); ?>> Yes
                      </label>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-md-6 col-sm-10">
                    <div class="checkbox icheck">
                      <label for="inputOutofStock">
                        <input type="checkbox" value="1" name="outofstock" id="inputOutofStock" <?= set_checkbox('outofstock','1'); ?>> Yes
                      </label>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-md-6 col-sm-10">
                    <div class="checkbox icheck">
                      <label for="popularproduct">
                        <input type="checkbox" value="1" name="popularproduct" id="popularproduct" <?= set_checkbox('popularproduct','1'); ?>> Yes
                      </label>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-md-6 col-sm-10">
                    <div class="checkbox icheck">
                      <label for="iscustomized">
                        <input type="checkbox" value="1" name="iscustomized" id="iscustomized" <?= set_checkbox('iscustomized','1'); ?>> Yes
                      </label>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-9 col-sm-10">
                    <textarea id="inputShortDescription" cols="30" rows="3" class="form-control ckeditor" name="short_description"><?= set_value('short_description'); ?></textarea>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-9 col-sm-10">
                    <textarea id="inputShortDescription" cols="30" rows="3" class="form-control ckeditor" name="list_description"><?= set_value('list_description'); ?></textarea>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-9 col-sm-10">
                    <textarea id="inputDescription" cols="30" rows="3" class="form-control ckeditor" name="description"><?= set_value('description'); ?></textarea>
                     <?= form_error('description'); ?>
                  </div>
                </div>
                 <div class="form-group">
                  <label for="inputSearchKeywords" class="col-sm-2 control-label">Search Keywords</label>
                  <div class="col-md-6 col-sm-10">
                    <textarea id="inputSearchKeywords" cols="30" rows="3" class="form-control" name="search_keywords"><?= set_value('search_keywords'); ?></textarea>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-9 col-sm-10">
                    <textarea id="inputKeyFeature" cols="30" rows="3" class="form-control ckeditor" name="key_feature"><?= set_value('key_feature'); ?></textarea>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-9 col-sm-10">
                    <textarea id="inputWarrenty" cols="30" rows="3" class="form-control ckeditor" name="warranty"><?= set_value('warranty'); ?></textarea>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-10">
                    <input type="text" class="form-control" id="inputPrice" name="price" value="<?= set_value('price'); ?>">
                    <?= form_error('price'); ?>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-10">
                    <input type="text" class="form-control" id="inputOldPrice" name="old_price" value="<?= set_value('old_price'); ?>">
