...
<?php $this->load->view('Backend/container/sidebar'); ?>
  ...
  <?php
     ...
     if($action=="Create")
	 {
		$actionurl=	base_url('Admin/Combinebasemotor/save/'); 
		$actionbtn="Submit";
	 }
	 else
	 {
		$actionurl=	base_url('Admin/Combinebasemotor/update/'.$basedataitems->base_id); 
		$actionbtn="Update";
	 }	 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?= base_url('Admin/combinebasemotor'); ?>">Combine Base Motor</a></li>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"><?php echo $action; ?> Combine Base Motor</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
			  ...
			  <form class="form-horizontal" id="frmbasemotor" name="frmbasemotor" method="post" onsubmit="return false;"   enctype="multipart/form-data">
					
                
                        <div id="repeater">
                            <div class="repeater-heading col-md-12" align="center">
							<br>
                                <button type="button" onclick="insertrow();" class="btn btn-primary repeater-add-btn">Add Base Motor</button>
							<br><br>
                            </div>
				 ...
				 ?>    		
					...
					<input type="hidden" data-skip-name="true" data-name="bm_motor_id[]" id="bm_motor_id" name="bm_motor_id[]" value="<?= set_value('bm_motor_id',@$data->bm_motor_id); ?>">
						
                            <div class="items" data-group="base_color">
                                <div class="item-content row">
				<div class="form-group">
				<div class="col-md-3">
                  <label for="inputCategory" class="col-sm-12 text-left">Motor *</label>
                  <div class="col-md-12 col-sm-12">
                  <select data-skip-name="true" data-name="motor_id[]" class="selectpicker required js-states form-control custome-select " data-live-search="true" name="motor_id[]" id="motor_id">
                      <option value="">Select motor</option>
                      <?php if(!empty($motor)){ 
                          foreach($motor as $info){
							
							  ?>
                          <option  value="<?= $info['id'] ?>"   <?= set_select('motor_id', $info['id'] ,($info['id'] == $data->motor_id ? TRUE:'') );?> ><?= $info['name']; ?></option>
                        <?php } } ?>  
                    </select>
				 ...
				 <div class="col-md-3">
                  ...
                  <div class="col-sm-12">
                   ...
                   <div class="col-sm-12">
                      <img src="<?= base_url('uploads/customizeimg/basemotor/'.$data->basepath); ?>" width="100px" height="100px" class="UploadImgPreview img-responsive">
                    </div>
				...
				<input type="hidden" data-skip-name="true" data-name="price[]" id="price"  name="price[]" value="0">
				 ...
				 <div class=" col-md-3">
				  ...
				  <div class="col-md-3 col-sm-3">
				   <button id="remove-btn" onclick="deleterow($(this).parents('.items'),'<?php echo $data->bm_motor_id; ?>','<?php echo $basedataitems->base_id; ?>');" class="btn btn-danger">Remove</button>
                </div>
                </div>
				</div>
				 </div>
					   ...
					   <div class="items" data-group="base_motor">
                                <div class="item-content row">
					<input type="hidden" data-skip-name="true" data-name="bm_motor_id[]" id="bm_motor_id" name="bm_motor_id[]" value="">				
				  ...
				  <div class="col-md-3 col-sm-3">
				   <button id="remove-btn" onclick="deleterow($(this).parents('.items'),'','<?php echo $basedataitems->base_id; ?>');" class="btn btn-danger">Remove</button>
					...
					?>		
					   ...
					   <button id="btninsert" onclick="frmsubmt('<?php echo $actionurl; ?>','frmbasemotor');" class="btn btn-success">Submit</button>
                 </div>
                    </form>
 ...
 <div style="display:none;" >
  ...
  <div class="newitems" data-group="base_motor">
                                <div class="item-content row">
					<input type="hidden" data-skip-name="true" data-name="bm_motor_id[]" id="bm_motor_id" name="bm_motor_id[]" value="">				
				...
				<div class="col-md-3">
                  <label for="inputCategory" class="col-sm-12 text-left">Motor *</label>
                  <div class="col-md-12 col-sm-12">
                  <select data-skip-name="true" data-name="motor_id[]" class="selectpicker required js-states form-control newcust-select " data-live-search="true" name="motor_id[]" id="motor_id">
                      <option value="">Select motor</option>
                      <?php if(!empty($motor)){ 
                          foreach($motor as $info){
  ...
  if (willDelete) {
	...
	if(bmid==""){	
		...
		else		
		{
			// alert("gg3");
			$.ajax({
                url:"<?php echo base_url('Admin/combinebasemotor/delete/') ?>"+bmid,
                type: "POST",
				data : "bid="+bid,
				dataType :"json",
				processData: false,				
