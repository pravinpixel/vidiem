        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Add FAQ - <?= $title; ?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
 <form class="form-horizontal" method="post" action="<?= base_url('Admin/faq/faqadd/'.$id); ?>" enctype="multipart/form-data">
              <div class="box-body">
                
                <div class="form-group">
                  <label for="inputQuestion" class="col-sm-2 control-label">Question</label>
                  <div class="col-md-6 col-sm-10">
                    <input type="text" class="form-control" id="inputQuestion" name="question" value="<?= set_value('question'); ?>">
                    <?= form_error('question'); ?>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-10">
                    <textarea class="form-control ckeditor" id="inputAnswer" name="content"><?= set_value('content'); ?></textarea>
                    <?= form_error('content'); ?>
                  </div>
                </div>
