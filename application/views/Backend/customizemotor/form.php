...
<?php $this->load->view('Backend/container/sidebar'); ?>
  ...
  <?php
     ...
     if($action=="Create")
	 {
		$actionurl=	base_url('Admin/Customizemotor/save/'); 
		$actionbtn="Submit";
	 }
	 else
	 {
		$actionurl=	base_url('Admin/Customizemotor/update/'.$dataitems->motor_id); 
		$actionbtn="Update";
	 }	 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?= base_url('Admin/customizemotor'); ?>">Customize Motor</a></li>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"><?php echo $action; ?> Customize Motor</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" id="frmcustmotor" name="frmcustmotor" method="post" action="<?php echo $actionurl; ?>"  enctype="multipart/form-data">
              <div class="box-body">
               ...
               <div class="form-group">
                  <label for="motorname" class="col-sm-2 control-label">Motor Name<span class="red">*</span></label>
                  <div class="col-md-6 col-sm-10">
                    <input type="text" class="form-control" required id="motorname" name="motorname" value="<?= set_value('motorname',@$dataitems->motorname); ?>">
                    <?= form_error('motorname'); ?>
                  </div>
                </div>
				
				    <div class="form-group">
                  <label for="code" class="col-sm-2 control-label">Motor Code<span class="red">*</span></label>
                  <div class="col-md-6 col-sm-10">
