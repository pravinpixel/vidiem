        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"> Manage State View</h3>
               <div class="pull-right">
                 <a href="<?php echo base_url('Admin/managestate/create');?>" class="btn btn-success">Add Service State <span class=""></span></a> 
              </div>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="box-body table-responsive">
              <table id="managestate" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th></th>
                  <th>S.No</th>
...
<?php
$ajaxurl="managestate/display_datatble_list";
$frmname="managestate";
$columns_arr=array("statename");
