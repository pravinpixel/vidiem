      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="post" action="<?= base_url('Admin/ProductRegistration/store'); ?>" >
              <div class="box-body">
                <div class="form-group">
                  <label for="inputName" class="col-sm-2 control-label">Product Name <span class="red">*</span></label>
                  <div class="col-md-6 col-sm-10">
                    <input type="text" class="form-control" id="inputName" name="product_name" value="<?= set_value('product_name'); ?>">
                ...
                <div class="form-group">
                  ...
                  <select class="selectpicker   required  js-states form-control custome-select registration_category" data-live-search="true" name="category_id" id="category_id">
                      ...
                      <?php if(!empty($registration_categories)){ 
                          ...
                          <option  value="<?= $info['id'] ?>"   <?= set_select('category_id',$info['id']);?> ><?= $info['category_name']; ?></option>
                        <?php } } ?>  
                    </select>
