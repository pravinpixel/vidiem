...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?= base_url('dealer-admin/dealers/'.$this->session->userdata('dealer_session')['dealer']['id'].'/location'); ?>"> Manage Location</a></li>
 ...
 <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="<?= base_url('dealer-admin'); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="<?= base_url('dealer-admin/dealers/'.$this->session->userdata('dealer_session')['dealer']['id'].'/location'); ?>"> Manage Sub Dealer</a></li>
            <li class="active"> <?php echo $action; ?></li>
        </ol>
    </section>
    <?php } ?>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    ...
                    <!-- form-horizontal -->
                    <form class="" enctype="multipart/form-data" id="location_form" action="<?= base_url(); ?>dealer-admin/location/save" name="location_form" method="post">
                            ...
                            <div class="col-sm-6 text-right">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8 form-margin-10" >
                                        <input type="text" class="form-control" required id="location_name" name="location_name"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8 form-margin-10">
                                        <input type="text" class="form-control" required id="dealer_erp_code" name="dealer_erp_code"
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-sm-6 ">
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group">
                                            <input type="hidden" name="sale_user_id" value="<?= $info->sale_user_id ?? '' ?>">
                                            <label for="s_user_code" class="col-sm-4 control-label">User Code </label>
                                            <div class="col-sm-8 form-margin-10" id="s_user_code_div">
                                                <input type="text" class="form-control"  id="s_user_code" name="s_user_code"
                                                    value="<?= set_value('s_user_code',@$info->s_user_code); ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="s_user_name" class="col-sm-4 control-label">Username </label>
                                            <div class="col-sm-8 form-margin-10" id="s_user_name_div">
                                                <input type="text" class="form-control"  id="s_user_name" name="s_user_name"
                                ...
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group">
                                            <input type="hidden" name="counter_user_id" value="<?= $info->counter_user_id ?? '' ?>">
                                            <label for="c_user_code" class="col-sm-4 control-label">User Code </label>
                                            <div class="col-sm-8 form-margin-10" id="c_user_code_div">
                                                <input type="text" class="form-control"  id="c_user_code" name="c_user_code"
                                                    value="<?= set_value('c_user_code',@$info->c_user_code); ?>">
                                                <?= form_error('c_user_code'); ?>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="c_user_name" class="col-sm-4 control-label">Username </label>
                                            <div class="col-sm-8 form-margin-10" id="c_user_name_div">
                                                <input type="text" class="form-control"  id="c_user_name" name="c_user_name"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-10">
                                    <button type="submit" id="location-submit" class="btn btn-success col-sm-3" style="margin-right:10px;">
                                        <?php echo $action_btn; ?>
                                    </button>

                                    <input type="reset" class="btn  col-sm-3 reset" id="reset" value="Reset"style="margin-right:10px;" />
                                    <a href="<?= base_url() ?>dealer-admin/dealers/<?= $dealer_id ?>/location" class="btn btn-dark bg-gray col-sm-3" style="margin-right:10px;"> Back </a>
                                </div>
                            </div>                        
                        </div>
...
$(document).ready(function() {
    $('#location_form').validate({
        submitHandler: function (form) {
            ...
            $.ajax({
                type: "POST",
                url: "<?= base_url(); ?>dealers/location/save",
                data:formData,
                // cache:false,
                // contentType: false,
                // processData: false,
