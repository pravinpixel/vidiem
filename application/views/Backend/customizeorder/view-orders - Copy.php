            ...
            <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <a href="#" class="btn bg-green customize_track_order" data-toggle="modal" data-target="#customize-track-order" data-id="<?= $info['id']; ?>" ><span class="fa fa-ship"></span></a>
                </td>
                  ...
                  <td>
                      ...
                      <a href="javascript:void(0);" class="btn bg-navy " onclick="return view_custom_order(<?= $info['id'] ?>)" data-original-title="view"><span class="fa fa-eye"></span></a>
