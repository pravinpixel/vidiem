						...
						?>
                                        ...
                                        <div>
                                            <div class="select-jar-last">
                                                <p class="jar-options">Choose from our Jar, Handle &amp; Lid options
                                                    <br /><a href="#" data-toggle="modal" data-target="#JarsModal"  >Click
                                                        Here!</a></p>
                                                <p class="jar-options-selected"><strong>You have selected <span
                                                            id="jarcnt">0</span> Jars</strong><br /><a href="#"
                                                        data-toggle="modal" data-target="#JarsModal">Click here to
                                                        change</a>
                                                <p>
                                            </div>
                                        </div>
