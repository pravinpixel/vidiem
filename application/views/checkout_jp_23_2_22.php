	...
	<section class="checkLeft clearfix">
		...
		<div id="tab-1" class="tab-content <?= (empty($client_id)?'current':''); ?> checkOutSingin clearfix">
			<div class="siginInSetTop clearfix">
					...
					<div class="siginInSetTop clearfix">
					<form class="sgInSet clearfix chkSignForm" id="signIn" method="POST">
						...
						<a href="javascript:void(0);" class="links chkForgotLink">Forgot Password</a> <button class="btn checkout_sign_in">Sign In</button>
					</form>

					<form class="sgInSet clearfix chkForgotForm hide" id="signIn" method="POST">
						<h4 class="siHead">FORGOT PASSWORD</h4>
						<ul class="createAcc">
							<li>
								<h5>Email Id</h5>
								<input type="text" placeholder="Enter email id" name="email">
								<div class="forgot_email_error"></div>
							</li>
						</ul>
						<a href="javascript:void(0);" class="links chkSignLink">Sign In</a> <button class="btn checkout_forgot">Send New Password</button>
					</form>

					<form class="signInput chkRegisterForm hide" method="POST">
						...
						<ul class="createAcc">
							...
							<li>
								<h5>Mobile Number</h5>
								<input type="text" placeholder="Mobile number"  minlength="10"     maxlength="10" name="mobile_no" class="register_mobile_no">
					...
					<form class="sgInSet gestLogin clearfix chkGuestForm hide" id="gestLogIn">
						<h4 class="siHead">Login with OTP</h4>
						<ul class="createAcc guest-detail">
							<li>
								<h5>Your Name</h5>
							...
							<li>
								<h5>Mobile Number</h5>
								<input type="text" placeholder="Mobile number"  minlength="10"   maxlength="10" name="guestmobile_no" class="guestregister_mobile_no">
						        <div class="guestregister_mobile_error"></div>
							</li>
						</ul>
						<button class="btn guestcheckout_register gestBtn guest-detail">Create  &nbsp;&nbsp;&nbsp;<i class="fa fa-circle-o-notch fa-spin login-loader" style="font-size:17px;display: none;" ></i></button>
					<ul class="createAcc guest-otp hide">
							<li>
								<h5>Your OTP</h5>
								<input type="text" placeholder="Enter your OTP" name="sms_code" class="guestregister_otp">
								<div class="sms_code_error"></div>
								<div class="sms_code_success" style="color: green;"></div>
							</li>
						</ul>
						<div style="display: flex;">
						<button class="btn guestcheckout_edit hide">Edit</button>&nbsp;
						<button class="btn guest-otp guest-otp-submit hide">Verify &nbsp;&nbsp;&nbsp;<i class="fa fa-circle-o-notch fa-spin login-loader" style="font-size:17px;display: none;"></i></button>
					    </div>
					</form>

						<div class="sociLogin">
								 <div class="">
								 <a class="btn" href="javascript:;" id="fb-login-button">
            						<img src="<?= base_url(); ?>assets/front-end/images/fbl.png" alt="fb" />
            						Log in with Facebook
            					</a>
								<p>OR</p></div>
								<a class="btn" href="javascript:open('<?php echo $loginURL; ?>', 'Google Login', 'height=500px,width=500px resizable=no')" style="background-color:#d94735">
									<img src="<?= base_url(); ?>assets/front-end/images/gpl.png" alt="fb" />
									Log in with Google
								</a> 
								
								<div class="chkRegisterDiv">
							        <p>OR</p>
									<a href="javascript:void(0)" class="linkerBtn btn chkRegisterLink">
										Register
									</a>
								</div>
								<div class="chkGuestDiv">
							        <p>OR</p>
								    <a href="javascript:void(0)" class="linkerBtn btn chkGuestLink">
										Login with OTP
									</a>
							    </div>
							    <div class="chkSignDiv hide">
							        <p>OR</p>
									<a href="javascript:void(0)" class="linkerBtn btn chkSignLink">
										Sign In
									</a>
								</div>
