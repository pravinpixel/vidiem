<!-- Newsletter -->
	  <section class="position-relative">
			<img src="<?= base_url(); ?>assets/front-end/images/newsletter-image.png" alt="" class="img-fluid newsletter-image"/>
		<div class="container">
					...
					<form action="" method="post" id="subForm" class="newsletter_form">
						<div class="md-form input-group">
							...
							<div class="input-group-append">
								<button class="btn btn-link m-0 px-3 newsletter_btn" type="button" id="MaterialButton-addon2">Subscribe Now</button>
							</div>
						</div>
					</form>
				</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-12 col-md-6 col-lg-3">
					...
					<p>1800-123-8436 (Toll Free)<br/><a href="mailto:care@vidiem.in" target="
					_blank">care@vidiem.in</a></p>
					<h4 class="mt-4">Payment Methods</h4>
					<img src="<?= base_url(); ?>assets/front-end/images/payment.png" alt=""/>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-sm-12 col-md-12 col-lg-6">
					<p class="text-right"><span class="text-white">Follow Us On</span> - <a target="_blank" href="https://www.facebook.com/VidiemTM/">Facebook</a> - <a target="_blank" href="https://twitter.com/vidiemmaya">Twitter</a> - <a target="_blank" href="https://www.instagram.com/vidiemtm/">Instagram</a> - <a target="_blank" href="https://www.youtube.com/channel/UCLJE5AoP7y7ccfFrMFyAv8g">Youtube</a></a></p>
				</div>
			</div>
		</div>
	  </footer>
	  ...
	  <script type="text/javascript" src="<?= base_url(); ?>assets/front-end/js/jquery-1.12.4.min.js"></script>
	  ...
	  <script src="<?= base_url(); ?>assets/front-end/js/select2.min.js"></script>	  
	 ...
	 <script src="<?= base_url(); ?>assets/front-end/js/bootstrap-datepicker.min.js" ></script>
