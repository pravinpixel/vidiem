   ...
   <div class="container">
      <div class="row align-items-center justify-content-center">
         <div class="col-sm-12 col-md-12 col-lg-6">
            ...
            <button class="selected-items-mobile red-btn" type="button"><i class="fa fa-check" aria-hidden="true"></i> Selected Items</button>
			...
			<div class="show-message" <?php echo $imprintCss; ?>><?php  echo $cartitems['bodyinfo'][0]['canvas_text']; ?></div>
			<?php 
		  ...
		  // print_r($cartitems['bodyinfo'][0]); die();
				   ?>
					...
					<?php 		
						 ...
						 ?>
               <img id="fullbaseimg" src="<?= base_url(); ?>assets/front-end/images/vidiem-by-you/Full_bg1.jpg" id="product-image" alt="" class="img-fluid"/>  
			<?php } ?>  
                  ...
                  <div id="accordion1" class="collapse show" aria-labelledby="heading1" data-parent="#by-you-accordion">
                     ...
                     <div class="text-center position-relative"><span class="mobile-text">Choose Body</span></div>
						...
						?>
                           ...
                           <button type="button" <?php echo $butdisabled; ?> class="red-btn" id="body-design-next">Accept</button>
                        </div>
                  </div>
               </div>
               </div>
						   ...
						   foreach($basecolorlist as $base_col) {
							...
							?>
							 ...
							 <a class="select-color <?php echo $clsactive; ?>" href="javascript:void(0);" onclick="fnbasecolorclick(this,'<?php echo $base_col['bm_color_id']; ?>','<?php echo base_url('uploads/customizeimg/basecolor/'.$base_col['basepath']) ?>','<?php echo@number_format($base_col['price'])?>');" >	
                              ...
                              <img src="<?php echo base_url('uploads/customizeimg/basecolor/'.$base_col['basepath']).'?t='.time(); ?>" alt="" class="img-fluid"/>
					...
					<?php 		   
					  ...
					  ?> 
						...
						?>
                           ...
                           <button <?php echo $butdisabled; ?> type="button" class="red-btn" id="body-color-next">Accept</button>
                        </div>
			   ...
			   <?php 
                  ...
                  <div id="accordion3" class="collapse" aria-labelledby="heading3" data-parent="#by-you-accordion">
					...
					<?php  
					 ...
					 <?php 
						...
						<div>
                              <div class="select-jar-last"><p class="jar-options">Choose from our Jars, Handle & Lids options <br/><a href="#" data-toggle="modal" data-target="#JarsModal">Click Here!</a></p>
				...
				?>
                        ...
                        <div class="next-btn">
                           ...
                           <button type="button" <?php echo $butdisabled; ?> class="red-btn"  id="jar-next">Accept</button>
                        </div>
                     </div>
                  </div>
               </div>
...
?>
                  ...
                  <div id="accordion4" class="collapse" aria-labelledby="heading4" data-parent="#by-you-accordion">
					...
					<?php	}	?>	 
							  ...
							  <div class="<?php echo ($clsactive != ' active ' ? 'd-none' : '')?> motor_view_info" id="motor_view_info_<?php echo $motor['motor_id']?>">
                                <a href="#" class="link" onclick="callMotorModal(<?php echo $motor['motor_id']?>)">view info</a>
                              </div>
                           </div>
					<?php		   
					   }
					...
					<?php
						...
						?>	
                           ...
                           <button <?php echo $butdisabled; ?> type="button" class="red-btn"   href="#" id="motor-next">Accept</button>
                        </div></div>
				...
				?>
                  ...
                  <div class="card-header <?php echo $clsgreenck; ?>" id="heading5">
                     <a href="#" class="btn btn-header-link collapsed" data-toggle="collapse" data-target="#accordion5"
                        aria-expanded="true" aria-controls="accordion5"><i class="fa fa-check-circle" aria-hidden="true"></i>  <span class="pc-text">Customized text on your mixer grinder</span></a>
                  </div>
                     ...
                     <div class="text-center position-relative"><span class="mobile-text">Message Imprinted</span></div>
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12">
								<p class="disclaimer"><strong>Disclaimer:</strong> Lorem Ipsum is simply dummy text of the printing and typesetting industry. </p>
                            </div> 
                        </div>
                            <div class="next-btn">
				...
				?>
                  ...
                  <div class="card-header <?php echo $clsgreenck; ?>" id="heading6">
                     <a href="#" class="btn btn-header-link collapsed" id="pack-pref" data-toggle="collapse" data-target="#accordion6"
                        aria-expanded="true" aria-controls="accordion6"><i class="fa fa-check-circle" aria-hidden="true"></i>  <span class="pc-text">Gift Wrapping preference</span></a>
                  </div>
                  <div id="accordion6" class="collapse" aria-labelledby="heading6" data-parent="#by-you-accordion">
                     <div class="card-body">
                     <div class="text-center position-relative"><span class="mobile-text">Gift Wrapping preference</span></div>
						...
						<?php 
						 ...
						 ?>
							 ...
							 <a class="custom-control custom-radio package-select mb-0 p-0 <?php echo $clsactive ?>" href="javascript:void(0);" onclick="fnpackageclick(this,'<?php echo $package['package_id']?>','<?= base_url()."uploads/customizeimg/".$package['basepath']; ?>','<?= @number_format($package['price']);?>');" >
                        ...
                        <div class="row justify-content-center">
						<div class="col-12 col-sm-12 col-md-12">
						<h6 class="text-left"><strong class="text-dark">Message on Gift Box</strong></h6>
						</div>
						<div class="col-5 col-sm-6 col-md-4">
						<select id="occasion_text" name="occasion_text" class="form-control">
							<option <?php echo $cartitems['bodyinfo'][0]['occasion_text']=="Anniversary"?'Selected':''; ?> value="Anniversary">Anniversary</option>
							<option <?php echo $cartitems['bodyinfo'][0]['occasion_text']=="Birthdays"?'Selected':''; ?> value="Birthdays">Birthdays</option>
							<option <?php echo $cartitems['bodyinfo'][0]['occasion_text']=="Christmas"?'Selected':''; ?> value="Christmas">Christmas</option>
							<option <?php echo $cartitems['bodyinfo'][0]['occasion_text']=="Easter"?'Selected':''; ?> value="Easter">Easter</option>
							<option <?php echo $cartitems['bodyinfo'][0]['occasion_text']=="Father Day"?'Selected':''; ?> value="Father Day">Father Day</option>
							<option <?php echo $cartitems['bodyinfo'][0]['occasion_text']=="Mother Day"?'Selected':''; ?> value="Mother Day">Mother Day</option>
							<option <?php echo $cartitems['bodyinfo'][0]['occasion_text']=="New Year Day"?'Selected':''; ?> value="New Year Day">New Year Day</option>
							<option <?php echo $cartitems['bodyinfo'][0]['occasion_text']=="Valentine Day"?'Selected':''; ?> value="Valentine Day">Valentine Day</option>
							<option <?php echo $cartitems['bodyinfo'][0]['occasion_text']=="Wedding"?'Selected':''; ?> value="Wedding">Wedding</option>
						</select>	
						</div>
                            <div class="col-7 col-sm-6 col-md-8">
                                <input type="text" maxlength="50" class="form-control"  value="<?php echo $cartitems['bodyinfo'][0]['message_text']; ?>" id="message_wish" />
         ...
         <div class="modal-body">
			...
			?>		 		
                        <div class="custom-checkbox">
                           <label>
                           <input onchange="fnjarfilter();" type="checkbox" id="capacity<?= $han['capacity_id'] ?>" name="capacity[]" value="<?= $han['capacity_id'] ?>">
                           <span class="box"></span>
                              ...
                              <div class="select-jar selectedjar-<?php echo $jar['jar_id']?> <?php echo $bflag==1?" active ":"";?> ">
                                 ...
                                 <div class="plus-minus">
                                    <div class="input-group">
                                       ...
                                       <button type="button" class="btn btn-number"  <?php echo $bflag==1 && $cartitems['jarinfo'][$jarkey]['qty'] == 0 ?"  disabled='disabled' ":"";?> data-type="minus" data-field="quant[<?php echo $jar['jar_id']?>]">
            ...
            <div id="divotherjarbutton" class="buttons mt-5">
			  ...
			  <div class="row">
                  <div class="col-sm-6">
                     <a class="black-btn" href="javascript:void(0);"  onclick="funremoveotherjars('<?= $active_bm_color_id;?>');">Remove jars</a>
                  </div>
                  <div class="col-sm-6">
                     <a class="red-btn" href="javascript:void(0);" onclick="funmodalclose('<?= $active_bm_color_id;?>');">Accept</a>
                  </div>
               </div>
					   <?php } ?> 
...
function funremoveotherjars(bid)
{
  ...
  /* $(".select-body").click(function(){
   ...
   $("#customize-button").on("click", function() {
    ...
    function callMotorModal(motorId) {
		$.ajax({
